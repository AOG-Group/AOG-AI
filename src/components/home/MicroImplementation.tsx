        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className={`transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-white leading-tight mb-6">
              Small, High-Leverage<br />
              Implementations Every Month
            </h2>
            <div className="space-y-4 text-[15px] text-gray-400 leading-relaxed">
              <p>
                Each month, every enrolled employee receives one scope-capped
                implementation deployed directly into their workflow. These are
                practical, immediately useful tools that compound over time.
              </p>
              <p>
            ...
            <div className="mt-6 rounded-xl border border-gray-800/50 bg-navy-900/30 p-5">
              <p className="text-sm text-gray-500 leading-relaxed">
                <span className="text-white font-medium">Scope note:</span> Micro-implementations
                are small, high-leverage solutions. Custom integrations, full system architecture,
                or bespoke software are scoped separately. This keeps the monthly program
